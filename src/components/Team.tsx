    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-20">
          <h2 className="text-4xl font-bold text-amber-900 mb-6">Die Meister hinter der Qualität</h2>
        ...
        <div className="grid md:grid-cols-2 gap-16 max-w-5xl mx-auto">
          <Card className="text-center hover:shadow-2xl transition-all duration-300 border-2 border-amber-200 bg-gradient-to-br from-white to-amber-50">
            <CardContent className="p-10">
              <div className="bg-amber-200 rounded-full w-40 h-40 mx-auto mb-8 flex items-center justify-center border-4 border-amber-300 shadow-lg">
                <p className="text-amber-700 font-medium">Foto Olaf Just</p>
              </div>
              <h3 className="text-3xl font-bold text-amber-900 mb-3">Olaf Just</h3>
              <p className="text-orange-700 font-bold mb-6 text-lg">Flaschnerei-Meister & Gründer</p>
          ...
          <Card className="text-center hover:shadow-2xl transition-all duration-300 border-2 border-amber-200 bg-gradient-to-br from-white to-amber-50">
            <CardContent className="p-10">
              <div className="bg-amber-200 rounded-full w-40 h-40 mx-auto mb-8 flex items-center justify-center border-4 border-amber-300 shadow-lg">
                <p className="text-amber-700 font-medium">Foto Sohn</p>
              </div>
              <h3 className="text-3xl font-bold text-amber-900 mb-3">[Name des Sohnes]</h3>
              <p className="text-orange-700 font-bold mb-6 text-lg">Flaschnerei-Meister</p>
              <p className="text-amber-800 mb-8 leading-relaxed">
