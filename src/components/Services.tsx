      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card key={index} className="premium-card transition-shadow duration-300 border border-slate-200/70 hover:border-orange-200/80 craft-card hover-lift overflow-hidden bg-white">
